...
var TimerRepository = /** @class */ (function () {
    function TimerRepository(firestore) {
        this.db = firestore;
    }
    TimerRepository.prototype.execute = function (timer) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.db.updateDoc(dbpath_1.userPathQuery(timer.ownerId), {
                                timer: __assign({}, timer),
                            })];
                    case 1:
                        _a.sent();
